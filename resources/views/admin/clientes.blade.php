...
<head>
    ...
    <title>Gestión de Clientes - GymLink</title>
    ...
    <aside class="w-64 bg-gray-800 border-r border-gray-700 flex flex-col justify-between hidden md:flex">
        <div>
            ...
            <nav class="mt-4 px-4 space-y-1">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-2.5 rounded-lg font-medium transition {{ request()->routeIs('admin.dashboard') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    Dashboard
                </a>
                <a href="{{ route('admin.clientes') }}" class="flex items-center px-4 py-2.5 rounded-lg font-medium transition {{ request()->routeIs('admin.clientes') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    Gestión de Clientes
                </a>
                <a href="{{ route('admin.coaches') }}" class="flex items-center px-4 py-2.5 rounded-lg font-medium transition {{ request()->routeIs('admin.coaches') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    Control de Coaches
                </a>
                <a href="{{ route('admin.membresias') }}" class="flex items-center px-4 py-2.5 rounded-lg font-medium transition {{ request()->routeIs('admin.membresias') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    Membresías
                </a>
                <a href="{{ route('admin.reportes') }}" class="flex items-center px-4 py-2.5 rounded-lg font-medium transition {{ request()->routeIs('admin.reportes') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    Reportes
                </a>
            </nav>
        </div>
    ...
    <div class="flex-1 flex flex-col h-full overflow-y-auto">
        ...
        <main class="p-6 space-y-6">
            <div class="flex justify-between items-center">
                ...
                <button class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition shadow">
                    + Nuevo Cliente
                </button>
            </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-700 text-sm">
                            <tr>
                                ...
                                <td class="py-3 px-4"><span class="bg-purple-900 text-purple-300 px-2.5 py-1 rounded-full text-xs font-semibold">Anual</span></td>
